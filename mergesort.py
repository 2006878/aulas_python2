'''Merge Sort é também chamado de ordenação por intercalação.
ìdéia básica: dividir para conquistar
-um vetor v é dividido em 2 partes, recursivamente.
-cada metade é ordenada e ambas são intercaladas formando o vetor ordenado.
-Usa um vetor auxiliar.'''
